...
import fun.kubik.events.api.main.EventStoppable;
import fun.kubik.events.api.type.Priority;
...
//        System.out.println("[EventManager] Registering class: " + object.getClass().getSimpleName());
        for (Method method : object.getClass().getDeclaredMethods()) {
            if (isMethodBad(method)) continue;
//            System.out.println("[EventManager] Registering method: " + method.getName() + " for event " + method.getParameterTypes()[0].getSimpleName());

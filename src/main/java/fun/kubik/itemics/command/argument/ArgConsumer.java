...
import fun.kubik.itemics.api.command.datatypes.IDatatype;
import fun.kubik.itemics.api.command.datatypes.IDatatypeContext;
import fun.kubik.itemics.api.command.datatypes.IDatatypeFor;
import fun.kubik.itemics.api.command.datatypes.IDatatypePost;
...
import fun.kubik.itemics.api.command.exception.CommandTooManyArgumentsException;

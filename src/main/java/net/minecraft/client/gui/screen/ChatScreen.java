/* Decompiler 63ms, total 378ms, lines 211 */
...
public class ChatScreen extends Screen implements IFastAccess {
    ...
    public boolean mouseClicked(double mouseX, double mouseY, int button) {
        Vector2f vec2f = GLHelpers.INSTANCE.normalizeCords(mouseX, mouseY, 1.0D);
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
        Vector2f vec2f = GLHelpers.INSTANCE.normalizeCords((double)mouseX, (double)mouseY, 1.0D);

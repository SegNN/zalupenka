...
public class ResourceLoadProgressGui extends LoadingGui
{
    ...
    {
        // Принудительно заливаем фон чёрным (или ванильным цветом)
        fill(matrixStack, 0, 0, this.mc.getMainWindow().getScaledWidth(), this.mc.getMainWindow().getScaledHeight(), 0xFF000000);

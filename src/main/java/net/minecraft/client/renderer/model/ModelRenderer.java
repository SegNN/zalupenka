/* Decompiler 147ms, total 885ms, lines 560 */
...
public class ModelRenderer {
    ...
    public final ObjectList<ModelRenderer.ModelBox> cubeList;
    public final ObjectList<ModelRenderer> childModels;
    ...
    public void render(MatrixStack matrixStackIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        if (this.showModel && (!this.cubeList.isEmpty() || !this.childModels.isEmpty() || !this.spriteList.isEmpty())) {
            ...
            Impl irendertypebuffer$impl = null;
            ...
            int k;
            for(k = 0; k < j; ++k) {
                ModelRenderer modelrenderer = (ModelRenderer)this.childModels.get(k);
                modelrenderer.render(matrixStackIn, bufferIn, packedLightIn, packedOverlayIn, red, green, blue, alpha);
            }

            k = this.spriteList.size();
    ...
    private void doRender(Entry matrixEntryIn, IVertexBuilder bufferIn, int packedLightIn, int packedOverlayIn, float red, float green, float blue, float alpha) {
        ...
        for(int j = 0; j < i; ++j) {
            ModelRenderer.ModelBox modelrenderer$modelbox = (ModelRenderer.ModelBox)this.cubeList.get(j);
    ...
    public ModelRenderer.ModelBox getRandomCube(Random randomIn) {
        return (ModelRenderer.ModelBox)this.cubeList.get(randomIn.nextInt(this.cubeList.size()));
    }
    ...
    public ModelRenderer getChild(int p_getChild_1_) {
        if (this.childModels == null) {
            ...
            return p_getChild_1_ >= 0 && p_getChild_1_ < this.childModels.size() ? (ModelRenderer)this.childModels.get(p_getChild_1_) : null;
        }
    }
    ...
    public String toString() {
        ...
        stringbuffer.append("id: " + var10001 + ", boxes: " + (this.cubeList != null ? this.cubeList.size() : null) + ", submodels: " + (this.childModels != null ? this.childModels.size() : null));
    ...
    public static class ModelBox {
        ...
        public VertexPosition[][] getBoxVertexPositions(int p_getBoxVertexPositions_1_) {
            ...
            return (VertexPosition[][])this.boxVertexPositions.get(p_getBoxVertexPositions_1_);
        }
    }

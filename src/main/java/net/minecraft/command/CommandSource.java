/* Decompiler 45ms, total 371ms, lines 262 */
...
public class CommandSource implements ISuggestionProvider {
    ...
    public CommandSource withEntityAnchorType(Type entityAnchorTypeIn) {
    ...
    public CommandSource withRotation(Entity entityIn, Type anchorType) throws CommandSyntaxException {
    ...
    private void logFeedback(ITextComponent message) {
        ITextComponent itextcomponent = (new TranslationTextComponent("chat.type.admin", new Object[]{this.getDisplayName(), message})).mergeStyle(new TextFormatting[]{TextFormatting.GRAY, TextFormatting.ITALIC});

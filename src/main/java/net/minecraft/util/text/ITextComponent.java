...
public interface ITextComponent
    ...
    default public <T> Optional<T> func_230534_b_(ITextProperties.IStyledTextAcceptor<T> acceptor, Style style) {
        if (Load.getInstance() != null && ((NameProtect)Load.getInstance().getHooks().getModuleManagers().findClass(NameProtect.class)).isToggled()) {
            return acceptor.accept(style, ((NameProtect)Load.getInstance().getHooks().getModuleManagers().findClass(NameProtect.class)).patch(this.getUnformattedComponentText()));
        }
    ...
    default public <T> Optional<T> func_230533_b_(ITextProperties.ITextAcceptor<T> acceptor) {
        if (Load.getInstance() != null && ((NameProtect)Load.getInstance().getHooks().getModuleManagers().findClass(NameProtect.class)).isToggled()) {
            return acceptor.accept(((NameProtect)Load.getInstance().getHooks().getModuleManagers().findClass(NameProtect.class)).patch(this.getUnformattedComponentText()));
        }

...
public class RenderSystem {
    ...
    public static void limitDisplayFPS(int p_limitDisplayFPS_0_) {
        double d0 = lastDrawTime + 1.0 / (double)p_limitDisplayFPS_0_;
    ...
    public static void glGenBuffers(Consumer<Integer> p_glGenBuffers_0_) {
        if (!RenderSystem.isOnRenderThread()) {
            RenderSystem.recordRenderCall(() -> p_glGenBuffers_0_.accept(GlStateManager.genBuffers()));
        } else {
    ...
    /**
     * Compatibility methods for SimpleVoiceChat
     */
    ...
    // Static import compatibility for direct method calls
